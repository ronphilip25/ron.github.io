...
export default function page() {
  return (
    <div class="px-2 sm:px-1.5 py-2.5 rounded bg-gradient-to-r from-blue-300 to-cyan-300">
    <div>
    <section className="items-center justify-between hidden sm:flex w-full md:flex md:w-auto md:order-1" id="mobile-menu-2">
    ...
    <li className='space-x-5 justify-evenly px-1 py-2'>
    <Link href={"/About/user"}><img className='h-10 w-10 rounded-lg max-w-xs hover:scale-125 shadow shadow-violet-400/90 hover:shadow-red-400/90 transition duration-300 ease-in-out' src='https://icons.veryicon.com/png/o/miscellaneous/two-color-icon-library/user-286.png'/></Link>
    </li>
  </ul>
